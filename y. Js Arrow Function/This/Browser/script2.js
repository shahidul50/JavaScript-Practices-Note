...
window.console.log("Global এ this এর value:",this);  //result: [window object]
console.log("Global এ this এর value:", this); //result: [window object]
...
function myFunc() {
  console.log("-------------");
  console.log("(Normal function এ (this) এর value:", this);  //result: undefined
}
myFunc();
...
const myObj2 = {
  ...
  fullName: function () {
    ...
    function abc() {
      console.log("-------*------");
      // console.log("abc Function = " + this.firstName +" "+ this.lastName);   //result: error
      console.log("Custom Object এ normal method এর মধ্যে normal function এ this এর value:", this);  //result: undefined
    }
    abc();
  },
};
